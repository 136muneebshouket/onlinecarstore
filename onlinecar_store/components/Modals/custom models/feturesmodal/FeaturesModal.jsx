...
const FeaturesModal = ({ carrdata , carfeatures}) => {
  const features = [
    ...
    { key1: 'CD Player', key2: 'cd_player' },
    { key1: 'Cassette Player', key2: 'cassette_player' },
    { key1: 'Cool Box', key2: 'cool_box' },
    { key1: 'Cruise Control', key2: 'cruise_control' },
    { key1: 'DVD Player', key2: 'dvd_player' },
    { key1: 'AM/FM Radio', key2: 'am_fm_radio' },
    { key1: 'Immobilizer Key', key2: 'immobilizer_key' },
    { key1: 'Keyless Entry', key2: 'keyless_entry' },
    { key1: 'Navigation System', key2: 'navigation_system' },
    { key1: 'Power Locks', key2: 'power_locks' },
    { key1: 'Power Mirrors', key2: 'power_mirrors' },
    { key1: 'Power Steering', key2: 'power_steering' },
    { key1: 'Power Windows', key2: 'power_windows' },
    { key1: 'Sun Roof', key2: 'sun_roof' },
    { key1: 'Rear Seat Entertainment', key2: 'rear_seat_entertainment' },
    { key1: 'Climate Control', key2: 'climate_control' },
    { key1: 'Rear AC Vents', key2: 'rear_ac_vents' },
    { key1: 'Front Speakers', key2: 'front_speakers' },
    { key1: 'Rear Speakers' , key2: 'rear_speakers' },
    { key1: 'USB and Auxillary Cable', key2: 'usb_and_auxillary_cable' },
    { key1: 'Heated Seats', key2: 'heated_seats' },
    { key1: 'Steering Switches', key2: 'steering_switches' },
    { key1: 'Front Camera', key2: 'front_camera' },
    { key1:  'Rear Camera', key2: 'rear_camera' }
  ]
