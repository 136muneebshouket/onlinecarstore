...
import bikesdata from '@/components/carsdata/bikesdata'
import {feature_generation} from "@/components/processing_functions/features_generations";


const Bikes_data_modal = ({ onClose, carrdata, filtermodal }) => {
...
// console.log(final_carsdata)
  ...
  const [carsoptions, setCarsoptions] = useState(bikesdata);
  ...
  const filter = useMemo(() => {
    // if (searchval !== "") {
    const filteredCarData = bikesdata.filter((brand) => {
...
export default React.memo(Bikes_data_modal);
