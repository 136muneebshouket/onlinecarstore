...
const Update_equip_modal = ({ modalvalue, onClose }) => {
  ...
  async function getequip() {
    ...
    await axios
      ...
      .then((res) => {
        ...
        setEquip_status({ ...equip_status, status: res?.data.payload.equip_status ,status_mark: res?.data.payload.status_mark })
  ...
  function select_status(a) {
    let v = a.split("&");
    if (v[1] == "") {
      setEquip_status({ ...equip_status, status: "", status_color: "", status_mark: 0 });
      return ;
    }
...
//  console.log(equip_status)
  ...
  async function upload_equipment() {
    ...
    // console.log(imagesto_delete, imgs_to_uplod)
                    ...
                    return (
                      <>
                        <option
                          ...
                          selected={v.status == equip_status.status ? true : false}
                        >
                          {v.status}
                        </option>
                      </>
