...
import Ad_section from "../Ads_approval_sec/Ad_sec/Ad_section";
      ...
      <div className="approval_ads_sec">
        ...
        >
          ...
          {ads?.map((v) => {
            return (
              <>
                <div key={v.ad_id} className="single_ad">
                  <p
                    onClick={() => {
                      getsingle_ad(v.ad_id);
                    }}
