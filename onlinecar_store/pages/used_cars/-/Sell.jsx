            ...
            <div className="divs ">
              ...
              <div className="cards">
                ...
                <div className="card steps">
                  ...
                  <h3>Sign up</h3>
                  <p>
                    Provide necessary details about your used car and make sure
                    to upload clear photos.
                  </p>
                </div>
                <div className="card steps">
                  <Image
              ...
              <div className="cards upload_cars">
                <div className="card q">
                  ...
                  <p>
                    ...
                    quality images have 90% more views and are likely to be sold
                    faster.
                  </p>
                  </div>
              ...
              <div className="cards overflow">
                <div className="card q tips">
                  ...
                  <p>
                    ...
                    can easily disappoint you to a great extent. Don’t get into
                    any trap of selling your car...
                  </p>
                </div>
                <div className="card q tips">
                  <img
                  ...
                  <p>
                    We all talk about the things you must check before buying a
                    used car. But let’s talk about things you should do before
                    selling car in pakistan. If you are selling it on the basis
                    of ‘as it is’ and have mentioned it in the ad as well, then
                    no point doing anything to...
                  </p>
                </div>
                <div className="card q tips">
                  <img
                  ...
                  <p>
                    ...
                    your car stand out from the crowd. Setting up a good ad for
                    your car requires a lot of time and effort, but that time
                    and effort will be worth it, as, in the end, you can earn
                    quite a good price for your car.
                  </p>
                </div>
              </div>
            </div>
