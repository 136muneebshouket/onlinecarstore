...
import Filter_bar_bikes from "@/components/Filters/FiIter_bar/Filter_bar_bikes";
...
const Search_bikes = ({ carrdata, loadiing, total , pagenum}) => {
      ...
      <div className="main_searchcar">
        ...
        <div className="cars_and_filters">
          ...
          <div className="cars">
            ...
            {carrdata?.length == 0 && (
              <>
                <h2>No Bikes with these filters..</h2>
              </>
            )}
...
export async function getServerSideProps({ params, query ,res}) {
  const resp = await axios.get(
    `${process.env.Host}/api/bikes_routes/usedbike_routes/getbikes/bikeswith_filters?filters=${query.filters}&limit=12&page=${query.page}`
  );
