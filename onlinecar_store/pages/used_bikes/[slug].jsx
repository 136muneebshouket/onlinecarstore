      ...
      <div className="singlecar_page">
        <div className="inner_main">
          <div className="car_section">
            ...
            <div className="car_comments">
              ...
              <p style={{ color: "#223C7A" }}>
                Mention CarSelection.com when calling Seller to get a good deal
              </p>
            </div>
          </div>
          ...
          <Contact_details className='contact_dtals' price={carrdata.price} phone={carrdata.Phone_no}/>
            ...
            <Reporting_add selleremail={carrdata.seller_email} ad_id={carrdata._id} type={'bike'} />
          </div>
        </div>
...
export async function getServerSideProps({ params, query,res }) {
    ...
    const resp = await axios.get(
      `${process.env.Host}/api/bikes_routes/usedbike_routes/getbikes/single_bike?id=${slugid}`
    );
